...
/**
 * Records a double-entry bookkeeping pair inside a Prisma transaction.
 * Both the debit (source) and credit (destination) entries are written
...
export async function recordTransfer(
    ...
    if (from.balance < amount)
        throw AppError.badRequest('Insufficient funds', 'INSUFFICIENT_FUNDS');
